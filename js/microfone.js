...
reconhecimento.onresult = (evento) => {
  ...
  if (
    fala.includes('ajuda') ||
    fala.includes('suporte') ||
    fala.includes('email')
  ) {
    window.location.href = 'telaSuporteIdoso.html';
  } else if (
    fala.includes('configuração') ||
    fala.includes('senha') ||
    fala.includes('perfil')
  ) {
    window.location.href = 'telaConfiguracaoIdoso.html';
  } else if (
    fala.includes('solicitação') ||
    fala.includes('pedido') ||
    fala.includes('solicitações')
  ) {
    window.location.href = 'telaSolicitacaoIdoso.html';
  } else if (
    fala.includes('tecnologia') ||
    fala.includes('celular') ||
    fala.includes('solicitar') ||
    fala.includes('card')
  ) {
